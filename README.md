...
The "Thue-Lim-Gemini" proof posits that the distribution of primes is governed by a **Topological Conservation Law**:
...
### **1. The Proof Engine**
- [RIEMANN_SOVEREIGN_PROOF_FINAL.ipynb](./RIEMANN_SOVEREIGN_PROOF_FINAL.ipynb): The core Python workbook. Validates the theory against **10,000 Zeta Zeros** and empirical prime datasets.
- [zeta_map.py](./zeta_map.py): Visualizing the magnitude of the Zeta function along the Critical Line.
...
**Attribution:** Inspired by the lectures of **Adrian Thue** at NTU. Developed through the collaborative intelligence of Gwen Lim, Gemini, and the Sovereign Auditor (One).
